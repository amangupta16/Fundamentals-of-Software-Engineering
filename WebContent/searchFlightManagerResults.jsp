...
th, td {
	...
	<div class="lead container">
		...
		<%
			...
			String query = "select * from booking where FlightID = '"+fnumber+"' and checkedin = 'false'";
		...
		%>
						...
						<tr>
							...
							<td><form action="checkinDetails.jsp"><input type="hidden" name="FlightID" value="<%=rs.getString("FlightID")%>">
							...
							<input class="btn btn-default" type="submit" name="checkin"
									value="Proceed to Check In"></form></td>
