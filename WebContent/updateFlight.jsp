			...
			try 
			{
				...
				if (rs.next()){ //valid flight id
					...
					if(rs.next()){ //flight has been booked
						//alert("Sorry! Flight has been booked, cannot remove");
						out.println("Sorry! Flight has been booked, cannot be updated <a href='updateFlight.html'>try again</a>");
						
					}else{ //flight has not been booked
						int i = st.executeUpdate("update flight set PlaneID ='"+ planeid +"', launch ='"+ launchID +"', destination='"+ destID +"', departure='"+ depart +"', arrive='"+ arrive +"', firstClassPrice='"+ FCP +"', businessClassPrice='"+ BCP +"', economyPrice='"+ ECP +"' where FlightID = '"+ flightid +"'");
						if(i > 0){
							//alert("Success! Flight has been removed");
					...
					//alert("Warning! Flight ID is invalid");
					out.println("Invalid flight ID <a href='updateFlight.html'>try again</a>");
				}
